...
const OUT = fileURLToPath(new URL('../src/lib/personaData.ts', import.meta.url));
...
const brandManifest = JSON.parse(
  readFileSync(fileURLToPath(new URL('../public/wardrobe/manifest.json', import.meta.url)), 'utf8')
);
