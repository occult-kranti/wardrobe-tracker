...
export interface CostPerWear {
  /** Rupees per wear, or null when there is no honest figure to state. */
  value: number | null;
...
/* ---------- formatting ----------
   ...
   style and `toFixed(0)` was off-contract. The quotes stand as history: by
   owner decision 2026-08-19 the currency is INR — the rupee sign and en-IN
   digit grouping (₹1,34,000, not ₹134,000). Display only; recorded amounts
   stay bare numbers. */

/** Whole units with separators: 1340 → "₹1,340", 134000 → "₹1,34,000". For sums and totals. */
